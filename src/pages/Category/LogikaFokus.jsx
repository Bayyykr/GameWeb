...
import SortirBarangGame from '../../components/game/SortirBarangGame';
    ...
    const gameModes = [
        {
            id: 'lengkapi-pola',
            title: 'Lengkapi Pola',
            description: 'Apa yang hilang dari urutan ini?',
            icon: lengkapiPolaIcon,
        ...
        },
        {
            id: 'cari-bayangan',
            title: 'Cari Bayangan',
            description: 'Temukan bayangan yang cocok!',
            icon: cariBayanganIcon,
        ...
        },
        {
            id: 'sortir-barang',
            title: 'Sortir Barang',
            description: 'Pisahkan buah dan sayur ke tempatnya.',
            icon: sortirBarangIcon,
        ...
        <div className="space-y-12">
                ...
                <>
                            ...
                            <div className="text-center md:text-left">
                                ...
                                <div className="inline-block bg-black/40 px-6 py-2 rounded-xl backdrop-blur-md border border-white/10 mt-2">
                                    <p className="text-amber-200 text-lg font-bold tracking-wide">
                                        Bermain sambil belajar logika dengan cara yang seru!
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <section>
                        <div className="flex items-center gap-4 mb-12">
                            ...
                            <h2 className="text-4xl font-black text-white tracking-widest uppercase drop-shadow-[0_4px_0_#1e1b4b]">PILIH PERMAINAN</h2>
                        </div>
            ...
            {gameMode && (
                typeof document !== 'undefined' ? createPortal(
                    ...
                    >
                        {/* Game Components */}
                        {gameMode === 'lengkapi-pola' && <PolaGambarGame onExit={handleExitGame} />}
                        {gameMode === 'cari-bayangan' && <CariBayanganGame onExit={handleExitGame} />}
                        {gameMode === 'sortir-barang' && <SortirBarangGame onExit={handleExitGame} />}
                    </div>,
                    document.body
                ) : null
            )}
            ...
            <style dangerouslySetInnerHTML={{
                ...
                .separate-animation {
                    animation: separate 0.5s ease-in forwards;
                }
